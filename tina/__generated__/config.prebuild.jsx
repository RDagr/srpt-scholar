    ...
    collections: [
      {
        ...
        ui: {
          filename: {
            readonly: false,
            slugify: (values) => {
              return (values?.slug || "new-topic").toLowerCase().replace(/\s+/g, "-");
            }
          },
          router: ({ document }) => {
        ...
        fields: [
          ...
          },
          {
            ...
            name: "slug",
            label: "URL Slug",
            description: "URL-friendly name, e.g., m1-garbhini-vigyana (lowercase, hyphens only)",
            required: true
          },
          {
            type: "string",
            ...
            fields: [
              {
                ...
                description: "Explain clinical importance in 2-3 sentences",
                ui: {
                  component: "textarea"
                }
              },
            ...
            fields: [
              {
                ...
                description: "e.g., Charaka Sharira Sthana 4/16",
                required: true
              },
              {
                type: "string",
          ...
          // ── Main content body (MDX) ──
          {
            ...
            description: "Any extra content \u2014 this appears at the bottom of the topic page. You can add tables, images, and more.",
            isBody: true
          }
        ]
      }
